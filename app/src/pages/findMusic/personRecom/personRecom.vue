...
<script>
import banner from "@/components/findMusic/personRecom/banner";
import recomSong from '@/components/findMusic/personRecom/recomSong'
import privateRec from '@/components/findMusic/personRecom/privateRec'
import newSong from '@/components/findMusic/personRecom/newSong'
import mvRecom from '@/components/findMusic/personRecom/mvRecom'
export default {
  name: "personRecom",
  components: {
    banner,
